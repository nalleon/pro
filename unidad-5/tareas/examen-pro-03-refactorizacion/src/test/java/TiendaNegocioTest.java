...
=======
    ...
    public void obtainAlimentosListTest(){
        Assertions.assertEquals(alimentoHashSet, tiendaNegocio.obtainAlimentosList(),
                "Expected result not found");
    }
    @Test
    public void obtainAparatosListTest(){
        Assertions.assertEquals(aparatoList, tiendaNegocio.obtainAparatosList(),
                "Expected result not found");
    }
    @Test
    public void obtainSouvenirListTest(){
        Assertions.assertEquals(souvenirHashMap, tiendaNegocio.obtainSouvernirsList(),
                "Expected result not found");
    }
    @Test
    public void obtainCuidadosListTest(){
        Assertions.assertEquals(cuidadoPersonalList, tiendaNegocio.obtainCuidadosPersonalesList(),
                "Expected result not found");
    }

    @Test
    public void obtainProductsListTest(){
        Assertions.assertEquals(productoAbstractsList, tiendaNegocio.obtainProducts(),
                "Expected result not found");
    }
    @Test
    public void obtainCertainProductsTest(){

        Assertions.assertEquals(alimento1, tiendaNegocio.obtainCertainProduct("ALM001"),
                "Expected result not found");
    }

    @Test
    public void obtainCertainProductNotExistTest(){
        Assertions.assertNotEquals(productoAbstractsList, tiendaNegocio.obtainCertainProduct("ALM007"),
                "Expected result not found");
    }
    ...
    public void addProductTest(){
        ...
        Assertions.assertEquals(3, tiendaNegocio.obtainAlimentosList().size(),
                "Expected result not found");
        Assertions.assertEquals(3, tiendaNegocio.obtainAparatosList().size(),
                "Expected result not found");
        Assertions.assertEquals(3, tiendaNegocio.obtainSouvernirsList().size(),
                "Expected result not found");
        Assertions.assertEquals(3, tiendaNegocio.obtainCuidadosPersonalesList().size(),
                "Expected result not found");
        Assertions.assertEquals(12, tiendaNegocio.obtainProducts().size(),
                "Expected result not found");
    }
    @Test
    ...
    public void totalPriceAparatosListTest(){
        ...
        Assertions.assertEquals(result, tiendaNegocio.totalPriceFromAparatos(), "Expected result not found");
    }

    @Test
    public void totalPriceSouvenirsListTest(){
        float result = 8.410999f;
        Assertions.assertEquals(result, tiendaNegocio.totalPriceFromSouvenirs(), "Expected result not found");
    }

    @Test
    public void totalPriceCuidadoListTest(){
        float result = 21.185999f;
        Assertions.assertEquals(result, tiendaNegocio.totalPriceFromCuidadoPersonal(), "Expected result not found");
    }
    ...
    public void totalEarningAparatosListTest(){
        ...
        Assertions.assertEquals(result, tiendaNegocio.totalEarningAparato(), "Expected result not found");
    }

    @Test
    public void totalEarningSouvenirsListTest(){
        float result = 1.940999f;
        Assertions.assertEquals(result, tiendaNegocio.totalEarningSouvenir(), "Expected result not found");
    }

    @Test
    public void totalEarningCuidadoListTest(){
        float result = 9.415999f;
        Assertions.assertEquals(result, tiendaNegocio.totalEarningCuidadoPersonal(), "Expected result not found");
    }
    ...
    public void popularityTest(){
        ...
        Assertions.assertEquals(popularResult, tiendaNegocio.popularity(), "Expected result not found");
    }
